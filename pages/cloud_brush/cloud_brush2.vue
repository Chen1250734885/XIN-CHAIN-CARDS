<template>
	<gracePage :customHeader="false">
		<view slot="gBody">
			...
			<view style="margin: 31rpx auto;  width:702rpx;height:550rpx;box-shadow:0px 2rpx 6rpx 0px rgba(129,78,171,0.3);border-radius:20rpx;">
				...
				<view class="grace-rows grace-flex-vcenter" style="margin:5rpx 0; width:702rpx;height:150rpx;background:rgba(255,255,255,1);"
				 @tap="showDialog1">
					<text style="margin-left: 19rpx;font-size:40rpx;font-weight:400;color:rgba(0,0,0,1);">收款账户:</text>
					<view class="grace-columns" style="text-align: center;">
						<view>
							<text style="font-size:30rpx;font-weight:400;color:rgba(51,51,51,1);">{{shoukuanname}}</text>
				...
				<view class="grace-rows grace-flex-vcenter" style="margin:5rpx 0; width:702rpx;height:150rpx;background:rgba(255,255,255,1);">
					<text style="margin-left: 19rpx;font-size:40rpx;font-weight:400;color:rgba(0,0,0,1);">消费地区:</text>
					<view class="grace-columns" style="text-align: center;" @tap="open1">
						<view>
							<text style="width: 300rpx;font-size: 30rpx;">{{cityText1}}</text>
							<image src="../../static/jiantou.png" style="width: 15rpx;height: 25rpx;position: relative;left: 30rpx;"></image>
						</view>
						<view style="width:500rpx;height:1rpx;background:rgba(51,51,51,1);opacity:0.5;margin-top: 10rpx;"></view>
					</view>
				</view>
				<!-- <view class="grace-rows grace-flex-vcenter" style="margin:5rpx 0; width:702rpx;height:150rpx;background:rgba(255,255,255,1);border-radius: 0rpx 0rpx 20rpx 20rpx ;"
				 @tap="showDialog2">
					<text style="margin-left: 19rpx;font-size:40rpx;font-weight:400;color:rgba(0,0,0,1);">消费通道:</text>
					<view class="grace-columns" style="text-align: center;">
						<view>
							<text style="font-size:30rpx;font-weight:400;color:rgba(51,51,51,1);">{{tongdaoname}}</text> -->
							<!-- <image src="../../static/jiantou.png" style="width: 15rpx;height: 25rpx;position: relative;left: 120rpx;"></image> -->
						<!-- </view>
						<view style="width:500rpx;height:1rpx;background:rgba(51,51,51,1);opacity:0.5;margin-top: 13rpx;"></view>
					</view>
				...
				<view class="grace-rows grace-flex-vcenter" style="margin:5rpx 0; width:702rpx;height:105rpx;background:rgba(255,255,255,1);" @tap="submit">
					<text style="margin-left: 19rpx;font-size:32rpx;font-weight:400;color:rgba(0,0,0,1);">手续费抵用券:</text>
					<view class="grace-columns" style="text-align: center;">
						<view style="position: relative;">
							<text style="font-size:25rpx;font-weight:bold;" :style="{color:coupon_id===''?'rgba(218,28,30,1)':'rgba(218,28,30,1)'}">{{coupon_id===''?'本次可抵扣'+max+'元，请选择抵用券':'-'+max+'（已抵扣）'}}</text>
		...
		methods: {
			...
			submit() {
				...
				if (vm.c_code === '' || vm.card_id === '') {
					...
					vm.Goto('/pages/cloud_brush/yunshu_voucher?max=' + this.max );
				}
			},
			// 云刷短信确认
			yansbumi() {
