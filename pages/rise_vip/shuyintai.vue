		...
		<view slot="gBody">
			...
			<view style="margin: 31rpx auto;  width:702rpx;height:400rpx;box-shadow:0px 2rpx 6rpx 0px rgba(129,78,171,0.3);border-radius:10rpx;">
				...
				<view class="grace-rows grace-flex-vcenter" style="margin:5rpx 0; width:702rpx;height:150rpx;background:rgba(255,255,255,1);"
				 @tap="showDialog1">
					<text style="margin-left: 19rpx;font-size:40rpx;font-weight:400;color:rgba(0,0,0,1);">收款银行:</text>
				...
				<!-- <view class="grace-rows grace-flex-vcenter" style="margin:5rpx 0; width:702rpx;height:105rpx;background:rgba(255,255,255,1);" @tap="xuanzediyong">
					<text style="margin-left: 19rpx;font-size:28rpx;font-weight:400;color:rgba(0,0,0,1);">手续费抵用券:</text>
					<view class="grace-columns" style="text-align: center;">
						...
						<view style="width:495rpx;height:1rpx;background:rgba(51,51,51,1);opacity:0.5;margin-top: 13rpx;"></view>
					</view>
				</view> -->
			</view>
	...
	export default {
		...
		methods: {
			...
			diyongquan(val) {
				...
				// 	vm.req.post(
				// 		vm.lochost + '/mytrunk/mycloudbrush/getcoupon', {
				// 			money: money
				// 		}, {},
				// 		function(res) {
				// 			vm.max = res.data.max;
