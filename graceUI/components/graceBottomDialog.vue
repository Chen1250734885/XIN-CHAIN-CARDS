...
.grace-btdialog-shade{position:fixed; width:100%; height:100%; left:0; top:0; z-index:999; background:rgba(0, 0, 0, 0.5);}
...
.grace-btdialog-shade .title{width:100%;border-bottom: 4rpx solid #F7F7F7;}
