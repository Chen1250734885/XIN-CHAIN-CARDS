<template>
	<gracePage :customHeader="false">
		...
		<view slot="gBody">
			<!-- 页面內容 -->
			<view style="margin: 15rpx auto;;width: 690rpx;height: 340rpx; background-size: contain;">
				...
				<swiper class="">
					<swiper-item v-for="(item1,index) in data" :key="index" style="margin-left: 50rpx;">
						<image :src="item1.img_url" mode="" style="width: 550rpx;height: 270rpx;margin: 30rpx 20rpx;"></image>
						<view class="swiper">
							<text>剩余：</text>
							<text style="background-color: #000000;border-radius:6px;padding: 0 5rpx;margin-right: 5rpx;">{{item1.num1}}</text>
							<text style="background-color: #000000;border-radius:6px;padding: 0 5rpx;margin-right: 5rpx;">{{item1.num2}}</text>
			...
			<view style="margin: 5rpx auto; background-image: url(../../static/rise_vip_youshi.png);background-size: contain;width: 690rpx;height: 340rpx;">
				<view style="position: relative;top:85rpx;left: 75rpx;">
					<view v-for="(item,index) in texts" :key="index" class="grace-rows">
						<view style="position: relative;top: 12rpx; width:8rpx;height:8rpx;background:rgba(67,63,51,1);border-radius:50%;"></view>
						<text style="margin-left: 20rpx; font-size:24rpx;font-weight:400;color:rgba(84,82,76,1);">{{ item }}</text>
					</view>
				</view>
			</view>
...
<style>
	...
	.swiper {
		transform: translate(316rpx, -80rpx);
		z-index: 99;
		color: #FFFFFF;
	}
