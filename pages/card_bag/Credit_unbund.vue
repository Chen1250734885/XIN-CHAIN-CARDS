<template>
	...
	<view>
		...
		<view style="margin-top: 2rpx; width:750rpx;height:100rpx;background:rgba(255,255,255,1);">
			<view class="grace-rows" style="position: relative;top: 30rpx;left: 38rpx;">
				<text style="font-size:28rpx;font-weight:400;color:rgba(51,51,51,1);">有效期：</text>
				<view class="grace-columns">
					<text style="font-size:28rpx;font-weight:400;color:rgba(51,51,51,1);margin-left: 110rpx;">{{bc_effective}}</text>
				</view>
			</view>
		</view>
		<view style="margin-top: 2rpx; width:750rpx;height:100rpx;background:rgba(255,255,255,1);">
			<view class="grace-rows" style="position: relative;top: 30rpx;left: 38rpx;">
				...
				<view class="grace-columns">
					<text style="font-size:28rpx;font-weight:400;color:rgba(51,51,51,1);margin-left: 120rpx;">***</text>
				</view>
			</view>
		</view>
		<view style="margin-top: 2rpx; width:750rpx;height:100rpx;background:rgba(255,255,255,1);">
			<view class="grace-rows" style="position: relative;top: 30rpx;left: 38rpx;">
				<text style="font-size:28rpx;font-weight:400;color:rgba(51,51,51,1);">账单日：</text>
				<view class="grace-columns">
					<text style="font-size:28rpx;font-weight:400;color:rgba(51,51,51,1);margin-left: 120rpx;">{{bc_bill+'日'}}</text>
				</view>
			</view>
		</view>
		<view style="margin-top: 2rpx; width:750rpx;height:100rpx;background:rgba(255,255,255,1);">
			<view class="grace-rows" style="position: relative;top: 30rpx;left: 38rpx;">
				<text style="font-size:28rpx;font-weight:400;color:rgba(51,51,51,1);">还款日：</text>
				<view class="grace-columns">
					<text style="font-size:28rpx;font-weight:400;color:rgba(51,51,51,1);margin-left: 120rpx;">{{bc_repayment+'日'}}</text>
				</view>
			</view>
		</view>
		<view style="margin-top: 2rpx; width:750rpx;height:100rpx;background:rgba(255,255,255,1);">
			<view class="grace-rows" style="position: relative;top: 30rpx;left: 38rpx;">
				...
				<view class="grace-columns">
					<text style="font-size:28rpx;font-weight:400;color:rgba(51,51,51,1);margin-left: 90rpx;">{{bank_tel}}</text>
				</view>
			</view>
		</view>
...
<script>
	export default {
		...
		onLoad(opt) {
			...
			this.bank_card = opt.bc_bank_number_c
			this.bank_name = opt.bank_name
			this.bank_tel = opt.bc_mobile
		...
		methods:{
			submit(){
				var vm = this
				vm.req.post(
					vm.lochost + '/index/index?method=del_credit',{
						bc_id:vm.bc_id
					},{},function(res){
						if (res.code == 200) {
							uni.showToast({
