<template>
	<view class="phone-main" :style="{height: winHeight + 'px'}">
		<!-- <view class="phone-main-search">
			<navigator :url="'phone-search?phones=' + phonesEscape+'&fakahang='+fakahang" hover-class="none">
				<input disabled="false" class="phone-main-input" type="text" placeholder="请输入银行名称"/>
			</navigator>
		</view> -->
...
<script>
	...
	export default {
		...
		mounted () {
			...
			//#ifdef APP-PLUS
			this.winHeight =(sysinfo.safeArea.height);
			//#endif
