		...
		<view slot="gBody">
			...
			<view style="margin-top: 35rpx;">
				...
				<view @tap="xuanzefakahang" class="grace-rows grace-flex-vcenter" style="width:750rpx;height:100rpx;background:rgba(255,255,255,1);">
					<text style="margin-left: 35rpx; font-size:28rpx;font-weight:400;color:rgba(51,51,51,1);">发卡行：</text>
					<text class="grace-ellipsis" style="position: relative; left: 70rpx; font-size:24rpx;font-weight:400;color:rgba(153,153,153,1);">{{ fakahangname != '' ? fakahangname:'请选择发卡行'}}</text>
			...
			<view style="margin-top: 1rpx;">
				<view class="grace-rows grace-flex-vcenter" style="width:750rpx;height:100rpx;background:rgba(255,255,255,1);">
					...
					<input type="number" v-model="chuxukahao"  placeholder="请输入储蓄卡号" style="margin-left: 30rpx;width: 500rpx;font-size: 24rpx;" @blur="jianche"/>
				</view>

				<view class="grace-rows grace-flex-vcenter" style="margin-top: 2rpx; width:750rpx;height:100rpx;background:rgba(255,255,255,1);">
					<text style="margin-left: 35rpx; font-size:28rpx;font-weight:400;color:rgba(51,51,51,1);">预留电话：</text>
					<input v-model="yuliudianhua" placeholder="请输入银行预留手机号码" style="margin-left: 60rpx;width: 500rpx;font-size: 24rpx;" />
				</view>
			...
			<view>
				<button @tap="subimt" style="margin-top: 70rpx; width:500rpx;height:90rpx;background:#1678FF;box-shadow:0px 2rpx 5rpx 0px rgba(67,67,67,0.3);border-radius:20rpx;font-size:32rpx;font-weight:400;color:rgba(255,255,255,1);">立即认证</button>
			</view>
		</view>
	</gracePage>
</template>
