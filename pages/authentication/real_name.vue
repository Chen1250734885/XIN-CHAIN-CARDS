					...
					<view class="grace-rows">
						<view class="grace-columns" style="position:relative;top: 168rpx;left: 115rpx;">
							...
							<view class="grace-rows" style="margin-top: 25rpx;">
								...
								<button @tap="xiugai" style="left: 40rpx; width:170rpx;height:50rpx;background:rgba(255,255,255,1);border-radius:15rpx;position: relative;font-size:24rpx;font-weight:400;color:#4F9FFE;line-height: 50rpx;z-index: 999;">
									修改信息
								</button>
							</view>
							<text style="margin-top: 25rpx; font-size:30rpx;font-weight:500;color:rgba(254,255,254,1);">{{ identity }}</text>
						</view>
					</view>
					<image src="../../static/yishiming.png" style="position: relative;bottom: 20rpx; left: 490rpx; width: 180rpx;height: 180rpx;"></image>
				</view>
			</view>
	</gracePage>
</template>
